<template>
<div>
    <div :class="{embeded : isEmbeded, dragging: dragging}" class="action-bar">   
       <!-- <button  class="btn btn--delta" @click="showCodeEditor">Edit Code</button>
...
export default {
    props: {
        cachedWidth: { type: String, default: '50%' },
