...
export default {
    ...
    metaInfo () {
		return {
			title: 'Chromagene',
			meta: [
				{property: 'og:title', content: 'Chromagene'},
				{property: 'og:site_name', content: 'Chromagene'},
				...
				{name: 'twitter:title', content: 'Chromagene'},
				...
				{itemprop: 'name', content: 'Chromagene'},
    ...
    data: function() {
        return {
            ...
            shaderSource: this.sculpData.shaderSource || ((this.sculpData.type && this.sculpData.type === 'glsl')? defaultFragSourceGLSL: 'line(vec3(0.2, 0.2, 0.0), vec3(0.2, 0.2, 0.0), 0.06); line(vec3(-0.2, -0.2, 0.0), vec3(-0.2, -0.2, 0.0), 0.06); line(vec3(0.2, 0.2, 0.0), vec3(0.02, 0.02, 0.0), 0.03); line(vec3(-0.2, -0.2,0.0), vec3(-0.02, -0.02, 0.0), 0.03);'),
