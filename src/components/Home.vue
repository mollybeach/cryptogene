<template>
<div>
<img alt='png' src='https://res.cloudinary.com/chromagene/image/upload/v1629516117/dna/firebasegene_u1bk4f.png'>
 <router-link to="/start"  class="header__link buttonH buttonH--size-xs buttonH--color" style="color: white; font-size: 20px;  align-items:center; width:40% "><button><span>Create</span></button></router-link>
	<!--<h1 v-show="!loading && $route.name !== 'featured'">New Sculptures</h1>-->

	<router-link to="/featured" class="link" style="margin-top: 5%"><h1 v-show="!loading">Featured NFTs ›</h1></router-link>
